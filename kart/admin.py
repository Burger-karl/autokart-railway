...
class CartModelAdmin(admin.ModelAdmin):
    ...
    def products(self,obj):
        link = reverse('admin:kart_product_change',args=[obj.product.pk])
...
class OrderPlacedModelAdmin(admin.ModelAdmin):
    ...
    def customers(self,obj):
        link = reverse('admin:kart_customer_change',args=[obj.customer.pk])
    ...
    def payments(self,obj):
        link = reverse('admin:kart_payment_change',args=[obj.payment.pk])
